        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card card-info">
                    ...
                    <!-- form start -->
                    <form
                        action="{{ isset($master) ? route('backend.masters.update', ['master_id' => $master->id]) : route('backend.masters.store') }}"
                        method="POST">
                        @csrf
                        @if(isset($master))
                            @method('patch')
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="surname"
                                               ...
                                               value="{{ $master->surname ?? old('surname') }}"
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="patronymic" class="form-control" id="patronymic"
                                               value="{{$master->patronymic ?? old('patronymic') }}"
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="position" class="form-control" id="position"
                                               value="{{ $master->position ?? old('position') }}"
