        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-info">
                    ...
                    <form action="{{ route('backend.applications.store') }}" method="POST">
                        @csrf
                        @method('POST')
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input name="client_phone" type="text" class="form-control maskinput"
                                ...
                                <div class="col-12 col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input name="additional_phone" type="text" class="form-control maskinput"
                                                   data-inputmask="'mask': ['9(999) 999-9999']"
                                                   data-mask="" inputmode="text">
                                        </div>
                                        <!-- /.input group -->
